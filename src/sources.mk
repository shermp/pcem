...
DOSBOX_SRC := dosbox/cdrom_image.cpp \
	dosbox/dbopl.cpp \
	dosbox/nukedopl.cpp \
	dosbox/vid_cga_comp.c

RESID_SRC := resid-fp/convolve.cc \
...
WIN_SRC := cdrom-ioctl.c \
	win-midi.c \
	wx-sdl2-display-win.c

WIN_RC_SRC := wx.rc

LINUX_SRC := cdrom-ioctl-linux.c \
	wx-sdl2-display.c

OSX_SRC := cdrom-ioctl-osx.c \
	wx-sdl2-display.c

OS_OTHER_SRC := cdrom-ioctl-dummy.c \
	wx-sdl2-display.c